...
class CarrosControllerTest < ActionController::TestCase
  ...
  test "should create carro" do
    assert_difference('Carro.count') do
      post :create, carro: { ano: @carro.ano, cor: @carro.cor, descricao: @carro.descricao, nome: @carro.nome }
    end
  ...
  test "should update carro" do
    patch :update, id: @carro, carro: { ano: @carro.ano, cor: @carro.cor, descricao: @carro.descricao, nome: @carro.nome }
    assert_redirected_to carro_path(assigns(:carro))
  end
